...
class GeminiGoldConfig(Base):
    ...
    max_open_positions = Column(Integer, default=0, nullable=False)
    ...
    trade_sessions = Column(JSON, nullable=True)
    custom_trade_hours_enabled = Column(Boolean, default=False, nullable=False)
    trade_hours_start_utc = Column(String(5), default="12:00", nullable=False)
    trade_hours_end_utc = Column(String(5), default="21:00", nullable=False)
...
class GeminiGoldReview(Base):
    ...
    timing_insights = Column(JSON, nullable=True)
    aggressiveness_insights = Column(JSON, nullable=True)
    ctrader_account_notes = Column(Text, nullable=True)
