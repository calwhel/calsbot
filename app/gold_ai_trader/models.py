...
class GoldAiConfig(Base):
    ...
    london_end_hour = Column(Integer, default=16, nullable=False)
    ny_start_hour = Column(Integer, default=12, nullable=False)
    ny_end_hour = Column(Integer, default=21, nullable=False)
