...
if [ "${EXECUTOR_ONLY}" = "1" ]; then
  ...
  export EXECUTOR_FOREX_MAX_CONCURRENT="${EXECUTOR_FOREX_MAX_CONCURRENT:-10}"
...
export PREFETCH_KRAKEN_CONCURRENT="${PREFETCH_KRAKEN_CONCURRENT:-3}"
export PREFETCH_YAHOO_CONCURRENT="${PREFETCH_YAHOO_CONCURRENT:-3}"
export PREFETCH_FMP_CONCURRENT="${PREFETCH_FMP_CONCURRENT:-3}"
