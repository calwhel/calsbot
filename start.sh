...
if [ "${RAILWAY_PRO}" = "1" ] || [ "${RAILWAY_EXECUTOR_TIER}" = "pro" ]; then
  _EXEC_PROFILE="pro"
  export BG_POOL_SIZE="${BG_POOL_SIZE:-24}"
  export BG_POOL_OVERFLOW="${BG_POOL_OVERFLOW:-28}"
  export BG_DB_RESERVE="${BG_DB_RESERVE:-6}"
  export BG_DB_MAX_CONCURRENT="${BG_DB_MAX_CONCURRENT:-32}"
  export EXECUTOR_SHARD_COUNT="${EXECUTOR_SHARD_COUNT:-4}"
  ...
  export EXECUTOR_CRYPTO_START_DELAY="${EXECUTOR_CRYPTO_START_DELAY:-30}"
  export EXECUTOR_SCAN_BATCH_SIZE="${EXECUTOR_SCAN_BATCH_SIZE:-25}"
  export EXECUTOR_PREFETCH_CONCURRENT="${EXECUTOR_PREFETCH_CONCURRENT:-20}"
