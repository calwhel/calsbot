...
class GoldAiOrbKillzoneDecoupleSourceTests(unittest.TestCase):
    def test_killzone_gate_kept_for_ict_but_not_orb(self):
        ...
        self.assertIn("if killzone_blocked and not orb_enabled:", LOOP)
        self.assertIn("if not killzone_blocked:", LOOP)
        ...
        self.assertIn("if killzone_blocked:", LOOP)
    ...
    def test_orb_runs_before_killzone_idle_return_and_before_ict_scan(self):
        ...
        killzone_idle_idx = LOOP.index("if killzone_blocked:", orb_idx)
