...
def test_fetch_gold_scoring_k5_direct_ctrader_when_tradfi_is_coinbase():
    ...
    async def _run():
        with patch(
            ...
            "app.gold_ai_trader.klines._fetch_ctrader_scoring_k5_direct",
            new_callable=AsyncMock,
            return_value=(snap, "ctrader"),
        ):
