...
- **Hybrid Signal System**: Multi-category signal generator with dynamic targets:
  ...
  - **SWING Signals** (Technical/Divergence/Reversal): 20%/40%/60% TPs, 25% SL - Multi-day trend plays. Includes EMA crossovers, MACD/RSI divergence, 5-pattern reversal scanner.
