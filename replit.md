...
- **AI-POWERED LONGS Strategy (Jan 2026)**: TA pre-filters require 5/6 confirmations before AI validation: (1) Liquidity $5M+, (2) Anti-manipulation ≤18%, (3) Trend alignment: BOTH 5m+15m bullish with EMA9>EMA21 by ≥0.3%, (4) RSI 42-62, (5) Volume ≥1.5x, (6) Price position <70% of range. AI sets dynamic TP/SL (2.5-5% TP, 2-4% SL). Rate limited: 5s between calls, max 10 AI calls per 5-min cycle.
