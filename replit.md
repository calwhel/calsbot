...
- **Momentum Runner Scanner**: TOP PRIORITY scanner. Scans Binance Futures 24h tickers for coins with momentum. TIGHTENED anti-top filters for earlier entries: 15% max 15m impulse, 25% max 1h impulse, 22% max 4h EMA extension, 30% max 24h change cap, RSI <72, EMA distance <3%, 5+ green 4h candles = sustained pump rejection. AI-gated with derivatives integration. Scans top 25 candidates per cycle.
