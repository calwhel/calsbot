...
- **NEW:** Fresh 30-minute pump detection - LONGS now require 10%+ gain in LAST 30M CANDLE (not stale 24h pumps)
- **IMPROVED:** Two-stage LONGS filtering: Quick 24h pre-scan → Deep 30m validation (2x volume, <35min freshness)
