...
- **AI Market Regime Detector (Jan 2026)**: Analyzes BTC and market conditions to identify current trading regime: TRENDING_UP, TRENDING_DOWN, RANGING, CHOPPY, or VOLATILE_BREAKOUT. Provides trading recommendations, position size modifiers, and preferred direction. Access via /market command. Auto-checks every 15 minutes.
...
- **AI-POWERED LONGS Strategy (Jan 2026)**: TA pre-filters require 4/6 confirmations before AI validation: (1) Liquidity $5M+, (2) Anti-manipulation ≤18%, (3) Trend: 5m bullish with EMA spread ≥0.15%, (4) RSI 35-68 (relaxed), (5) Volume ≥1.2x (relaxed), (6) Price position <80% (relaxed). AI sets dynamic TP/SL (2.5-5% TP, 2-4% SL). Rate limited: 5s between calls.
