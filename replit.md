...
- **Cooldown Systems**: Prevents re-shorting symbols immediately after a stop-loss (can be bypassed for parabolic shorts). LONGS have 24-hour per-symbol cooldown for fresher plays. Shorts have standard 2-hour cooldown.
...
- **AI-POWERED LONGS Strategy (Jan 2026 - TIGHTENED v4)**: Targets coins from -50% to +100% with STRICT 6/6 confirmations before AI validation: (1) Liquidity $5M+, (2) Anti-manipulation, (3) Trend: BOTH 5m AND 15m bullish with EMA spread ≥0.40%, (4) RSI 40-58 (tightened), (5) Volume ≥1.5x (tightened), (6) Price position <65% (tightened). AI sets TP/SL levels. Tightened after 5 consecutive losses.
