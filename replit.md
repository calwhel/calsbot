...
- **AI-POWERED LONGS Strategy (Jan 2026 - ULTRA STRICT v2)**: Only targets coins +2% to +12% on the day (early momentum). TA pre-filters require ALL 6/6 confirmations before AI validation: (1) Liquidity $5M+, (2) Anti-manipulation ≤18%, (3) Trend: BOTH 5m AND 15m bullish with EMA spread ≥0.30%, (4) RSI 45-58 (ultra strict - tight momentum zone), (5) Volume ≥1.8x (ultra strict), (6) Price position <55% (ultra strict - only buy pullbacks). Additional filters: (7) BTC must be stable/bullish (>-1.5%), (8) At least 2 of last 3 candles must be GREEN (strong momentum), (9) No lower-lows (uptrend structure required). AI validation requires A+/A quality with confidence ≥8. Prompt emphasizes quality over quantity. Rate limited: 5s between calls.
