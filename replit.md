...
- **Signal Frequency Limits (Jan 2026)**: Max 2 trades per 4-hour fixed window, max 6 signals/day total, max 3 shorts/day. FIXED Jan 2026: Now counts actual Trade table entries (executed trades) instead of Signal table entries, preventing false "1/2" counts when AI rejects signals or users lack auto-trading.
