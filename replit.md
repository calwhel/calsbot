...
- **Signal Frequency Limits (Jan 2026)**: Max 2 trades per 4-hour fixed window, max 6 signals/day total, max 3 shorts/day. FIXED Jan 2026: Now counts only automated scanner trades (Trade entries with signal_id) instead of all trades or Signal entries. Prevents false counts from manual/copy trades or AI rejections.
