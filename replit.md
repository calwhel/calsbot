...
- **PURE TA LONGS Strategy (Jan 2026 Refactor)**: No AI - strict TA-only signal generation requires ALL 6/6 confirmations: (1) Liquidity $5M+, (2) Anti-manipulation ≤18%, (3) Trend alignment: BOTH 5m+15m bullish with EMA9>EMA21 by ≥0.3%, (4) RSI 42-62, (5) Volume ≥1.5x, (6) Price position <70% of range. Static TP/SL: 3.6% TP (72% profit at 20x), 3.0% SL (60% loss at 20x). Targets 4-6 quality signals/day.
